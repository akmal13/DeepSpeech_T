...
python -u DeepSpeech.py \
  --train_files data/lldd/ldc93s1.csv \
  --dev_files data/lldd/ldc93s1.csv \
  --test_files data/lldd/ldc93s1.csv \
  --train_batch_size 1 \
  --dev_batch_size 1 \
  --test_batch_size 1 \
  --n_hidden 494 \
